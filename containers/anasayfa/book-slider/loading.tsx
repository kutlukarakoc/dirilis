...
const SliderLoading = () => {
  return (
    <div className="mb-32 flex flex-col items-center justify-center space-y-4 md:mb-40 md:flex-row md:space-x-4 md:space-y-0 md:py-0 lg:space-x-8 xl:space-x-14 2xl:space-x-20">
