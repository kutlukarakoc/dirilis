      ...
      >
        {quotesData.map((item, index) => (
          <SwiperSlide key={index}>
            <div className="mx-auto flex h-full w-full flex-col items-center justify-start space-y-4 py-2 sm:w-[90%] sm:justify-center md:flex-row md:space-y-0 md:py-0 md:space-x-4 lg:space-x-8 xl:space-x-14 2xl:space-x-20">
              <QuoteImage
